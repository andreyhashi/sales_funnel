...
const SaleProgressionModal = props => {
  ...
  return (
    <div className="box-shadow-modal border-rounded left-50p top-30p transform-translate-m50 max-width-600 width-100 absolute bg-white height-auto z-index-1">
